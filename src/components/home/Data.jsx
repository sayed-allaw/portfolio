...
function Data() {
  return (
    <div className="home__data">
        <h1 className="home__title">sayed allaw
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm creative Devolper based in Qalyubia,
            and I'm very passionate amd dedicated to my Work.
        </p>
